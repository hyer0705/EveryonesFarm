...
<div id="termsOfUseModal" class="modal">
	...
	<div class="modal-content">
		<div class="modal-content__top">
			<span>모두의 농장 이용약관</span><span class="close">&times;</span>
		</div>
		<div class="modal-content__middle">
			<span>모두의 농장 이용약관은 다음과 같습니다.</span>
		</div>
		<div class="modal-content__bottom">
		제1조(목적) 이 약관은 "(주)FarmCompany(전자상거래 사업자)"가 운영하는 "모두의 농장 사이버 몰(이하 “몰”이라 한다)"에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
		<br>
		...
		제2조(정의)
		<br>
		① “몰”이란 "(주)FarmCompany"가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
		<br>
...
<!-- privacy plicy modal  -->
<div id="privacyPolicyModal" class="pmodal">
	<!-- Modal content -->
	<div class="modal-content">
		<div class="modal-content__top">
			<span>모두의 농장 개인정보처리방침</span><span class="close">&times;</span>
		</div>
		<div class="modal-content__middle">
			<span>모두의 농장 개인정보처리방침은 다음과 같습니다.</span>
		</div>
		<div class="modal-content__bottom">
		1. 개인정보의 처리 목적 (‘https://everyonesfarm.com’이하 ‘모두의 농장’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.
<br>
- 고객 가입의사 확인, 고객에 대한 서비스 제공에 따른 본인 식별.인증, 회원자격 유지.관리, 물품 또는 서비스 공급에 따른 금액 결제, 물품 또는 서비스의 공급.배송 등
<br>
2. 개인정보의 처리 및 보유 기간
<br>
① (‘https://everyonesfarm.com’이하 ‘모두의 농장’) 은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유․이용기간 또는 법령에 따른 개인정보 보유․이용기간 내에서 개인정보를 처리․보유합니다.
<br>
...
<br>
① ('https://everyonesfarm.com'이하 '모두의 농장')은(는) 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.
<br>
② ('https://everyonesfarm.com')은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.
<br>
1.
<br>
개인정보를 제공받는 자 :
...
4. 개인정보처리 위탁
<br>
① ('모두의 농장')은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.
<br>
1.
<br>
위탁받는 자 (수탁자) :
...
위탁기간 :
<br>
② ('https://everyonesfarm.com'이하 '모두의 농장')은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.
<br>
③ 위탁업무의 내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보 처리방침을 통하여 공개하도록 하겠습니다.
<br>
5. 정보주체와 법정대리인의 권리·의무 및 그 행사방법 이용자는 개인정보주체로써 다음과 같은 권리를 행사할 수 있습니다.
<br>
① 정보주체는 FarmCompany(‘https://everyonesfarm.com’이하 ‘모두의 농장) 에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.
<br>
1. 개인정보 열람요구
<br>
2. 오류 등이 있을 경우 정정 요구
...
6. 처리하는 개인정보의 항목 작성
<br>
① ('https://everyonesfarm.com'이하 '모두의 농장')은(는) 다음의 개인정보 항목을 처리하고 있습니다.
<br>
1[프로그램 개발 위탁, 본인 확인 절차 등]
필수항목 : 이메일, 휴대전화번호, 자택주소, 비밀번호, 로그인ID, 이름
<br>
- 선택항목 : 생년월일, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록
<br>
<br>
7. 개인정보의 파기('모두의 농장')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.
<br>
-파기절차
<br>
...
<br>
① FarmCompany 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠기(cookie)’를 사용합니다. ② 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 컴퓨터 브라우저에게 보내는 소량의 정보이며 이용자들의 PC 컴퓨터내의 하드디스크에 저장되기도 합니다. 가. 쿠키의 사용 목적 : 이용자가 방문한 각 서비스와 웹 사이트들에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부, 등을 파악하여 이용자에게 최적화된 정보 제공을 위해 사용됩니다. 나. 쿠키의 설치•운영 및 거부 : 웹브라우저 상단의 도구>인터넷 옵션>개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을 거부 할 수 있습니다. 다. 쿠키 저장을 거부할 경우 맞춤형 서비스 이용에 어려움이 발생할 수 있습니다.
<br>
9. 개인정보 보호책임자 작성
<br>
① FarmCompany(‘https://everyonesfarm.com’이하 ‘모두의 농장) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
<br>
▶ 개인정보 보호책임자
<br>
성명 :조혜린
...
직급 :차장
<br>
연락처 :01012345678, h_123@test.com, 0212345678
<br>
※ 개인정보 보호 담당부서로 연결됩니다.
<br>
<br>
...
연락처 :01012345678, h_123@test.com, 0212345678
<br>
② 정보주체께서는 FarmCompany(‘https://everyonesfarm.com’이하 ‘모두의 농장) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. FarmCompany(‘https://everyonesfarm.com’이하 ‘모두의 농장) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
<br>
10. 개인정보 처리방침 변경
<br>
...
<br>
<br>
11. 개인정보의 안전성 확보 조치 ('모두의 농장')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.
<br>
1. 정기적인 자체 감사 실시
<br>
...
<!-- Modal content -->
	<div class="modal-content">
		<div class="modal-content__top">
			<span>모두의 농장 이메일 무단수집 거부</span><span class="close">&times;</span>
		</div>
		<div class="modal-content__middle">
			<span>모두의 농장 이메일 무단수집 거부</span>
		</div>
		<div class="modal-content__bottom" style="height: auto;">
		본 웹사이트는 게시된 이메일 주소가 전자우편 수집 프로그램이나 그 밖의 기술적 장치를 이용하여 무단 수집되는 것을 거부합니다.
		<br>이를 위반시 『정보통신망 이용 촉진 및 정보보호 등에 관한 법률』등에 의해 처벌 받을 수 있습니다.
		<br>※ 정보통신망 이용촉진 및 정보보호 등에 관한법률 제50조의 2 (전자우편주소의 무단 수집행위 등 금지)
		</div>
	</div>
</div>
